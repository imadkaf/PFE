...
class __TwigTemplate_78eab197ea263c9c284647a90622b7d884834cc09a02b4e35111ca2931a0bed8 extends Twig_Template
{
    ...
    {
        // line 1
        list($context["big_image_alias"], $context["items_count"]) =         array("gallery", twig_length_filter($this->env, (isset($context["valid_items"]) ? $context["valid_items"] : null)));
        // line 2
        echo "<!-- BLOCK: START -->
<div class=\"block-type-gallery\">
    ...
    <div class=\"block-gallery\">
        ...
        // line 9
        echo "            ";
        echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('http_kernel')->controller("ez_content:viewLocation", array("locationId" => $this->getAttribute($this->getAttribute((isset($context["valid_items"]) ? $context["valid_items"] : null), 0, array(), "array"), "locationId", array()), "viewType" => "gallery_viewer", "params" => array("image_alias" => (isset($context["big_image_alias"]) ? $context["big_image_alias"] : null), "total_items" => (isset($context["items_count"]) ? $context["items_count"] : null)))));
        // line 18
        echo "
        </div>
