...
class __TwigTemplate_3d751a636d90a17b4f2122dad0cf47fbc1df018c0660d89777087436dd5a0a6d extends Twig_Template
{
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        echo "</h1>
                ...
                <div id=\"place-list-container\">
                    ";
        // line 45
        echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('http_kernel')->controller("eZDemoBundle:Place:listPlaceList", array("locationId" => $this->getAttribute((isset($context["location"]) ? $context["location"] : null), "id", array()))));
        // line 50
        echo "
                </div>
            </div>
    ...
    <script>
        YUI(YUI3_config).use('io-base', 'node', function(Y) {
            ...
            var uriTemplate = '";
        // line 59
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ezpublish_ezdemo_ajax_sorted_place_list", array("locationId" => $this->getAttribute((isset($context["location"]) ? $context["location"] : null), "id", array()), "latitude" => "key_lat", "longitude" => "key_lon", "maxDist" => "key_dist")), "html", null, true);
        // line 62
        echo "',
                noGeoLocateMsg = '";
        // line 63
            ...
            sortedPlaceButton.on('click', function (e) {
                ...
                navigator.geolocation.getCurrentPosition(function (position) {
                    ...
                    if (maxDist == 0) {
                        uri = '";
        // line 153
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ezpublish_ezdemo_ajax_default_placeList", array("locationId" => $this->getAttribute((isset($context["location"]) ? $context["location"] : null), "id", array()))), "html", null, true);
        echo "';
                    } else {
