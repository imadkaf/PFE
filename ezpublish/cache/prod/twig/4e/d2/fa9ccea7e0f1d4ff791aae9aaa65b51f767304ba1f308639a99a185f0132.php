...
class __TwigTemplate_4ed2fa9ccea7e0f1d4ff791aae9aaa65b51f767304ba1f308639a99a185f0132 extends Twig_Template
{
    ...
    public function block_ez_legacy_render_css($context, array $blocks = array())
    {
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["css_files"]) ? $context["css_files"] : null));
    ...
    ";
        // line 7
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["css_code_lines"]) ? $context["css_code_lines"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 8
