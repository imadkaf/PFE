...
class __TwigTemplate_ffb0c58657ce3b10c7fde40ef29f45de7c5da000dcc0ba5cf9eb1370ba0c5c43 extends Twig_Template
{
...
";
        // line 19
        if ((array_key_exists("location", $context) && (!$this->getAttribute((isset($context["location"]) ? $context["location"] : null), "isDraft", array())))) {
            // line 20
            echo "    ";
            $context["currentLocation"] = (isset($context["location"]) ? $context["location"] : null);
        }
        // line 22
        echo "
...
";
        ...
        if (array_key_exists("currentLocation", $context)) {
            // line 25
            echo "    ";
            echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('http_kernel')->controller("ezpublish_legacy.website_toolbar.controller:websiteToolbarAction", array("locationId" => $this->getAttribute((isset($context["currentLocation"]) ? $context["currentLocation"] : null), "id", array()))));
            echo "
";
        }
        // line 27
    ...
    <div class=\"navbar main-navi\">
        ...
        ";
        // line 46
        if ((array_key_exists("pageData", $context) && $this->getAttribute((isset($context["pageData"]) ? $context["pageData"] : null), "showPath", array()))) {
            // line 47
            echo "            ";
    ...
    <div class=\"container\">
        ...
        echo "        <div class=\"row\">
            ...
            <div class=\"span";
        // line 61
        echo twig_escape_filter($this->env, ((array_key_exists("innerColumnSize", $context)) ? (_twig_default_filter((isset($context["innerColumnSize"]) ? $context["innerColumnSize"] : null), 12)) : (12)), "html", null, true);
        echo " main-content\">
                ";
        // line 62
...
";
    ...
    public function block_topMenu($context, array $blocks = array())
    {
        // line 36
        echo "            ";
        echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('http_kernel')->controller("eZDemoBundle:Menu:topMenu", array("currentLocationId" => ((array_key_exists("currentLocation", $context)) ? ($this->getAttribute((isset($context["currentLocation"]) ? $context["currentLocation"] : null), "id", array())) : (null)))));
        // line 41
        echo "
        ";
    }
    ...
    public function block_breadcrumb($context, array $blocks = array())
    {
        ...
        if (array_key_exists("currentLocation", $context)) {
            // line 56
            echo "                ";
            echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('http_kernel')->controller("eZDemoBundle:Demo:viewBreadcrumb", array("locationId" => $this->getAttribute((isset($context["currentLocation"]) ? $context["currentLocation"] : null), "id", array()))));
            echo "
            ";
        }
        // line 58
