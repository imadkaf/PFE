...
class __TwigTemplate_b5e3f95c8d96dbf3eb1e430f0523766d4a99be667a26c93b5363d24c70dc574b extends Twig_Template
{
...
<article>
    <div class=\"attribute-video\">
        ...
        // line 9
        echo "        ";
        echo $this->env->getExtension('ezpublish.content')->renderField((isset($context["content"]) ? $context["content"] : null), "file", array("attr" => array("id" => ("video_" . ((array_key_exists("block_id", $context)) ? (_twig_default_filter((isset($context["block_id"]) ? $context["block_id"] : null), "")) : (""))), "class" => "video-js vjs-default-skin", "data-setup" => "{}"), "template" => "eZDemoBundle:fields:ezbinaryfile_video.html.twig"));
        // line 16
        echo "
    </div>
