...
class __TwigTemplate_b5d30a1254be8a3acd455ccfaf8d847158d8887e3acc003a1870e2c85a8ef0cc extends Twig_Template
{
    ...
    <script type=\"text/javascript\">
        ...
        // line 4
        echo twig_escape_filter($this->env, (isset($context["shortname"]) ? $context["shortname"] : null), "html", null, true);
        echo "';
        ";
        // line 5
        if (array_key_exists("identifier", $context)) {
            echo "var disqus_identifier = '";
            echo twig_escape_filter($this->env, (isset($context["identifier"]) ? $context["identifier"] : null), "html", null, true);
            echo "';";
        }
        // line 6
        echo "
